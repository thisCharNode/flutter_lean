    ...
    _i5.LoginView: (data) {
      ...
      return _i6.PageRouteBuilder<dynamic>(
        pageBuilder: (context, animation, secondaryAnimation) =>
            _i5.LoginView(key: args.key, backTest: args.backTest),
        settings: data,
...
class LoginViewArguments {
  ...
  final dynamic backTest;

  @override
  String toString() {
    return '{"key": "$key", "backTest": "$backTest"}';
  }

  @override
  bool operator ==(covariant LoginViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.backTest == backTest;
  }

  @override
  int get hashCode {
    return key.hashCode ^ backTest.hashCode;
  }
}
...
extension NavigatorStateExtension on _i7.NavigationService {
  Future<dynamic> navigateToHomeView({
    _i6.Key? key,
    required dynamic startingIndex,
    int? routerId,
  ...
  Future<dynamic> navigateToLoginView({
    ...
    return navigateTo<dynamic>(Routes.loginView,
        arguments: LoginViewArguments(key: key, backTest: backTest),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
